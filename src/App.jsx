...
function App() {
  ...
  const hasStarted = directionRef.current !== INITIAL_DIRECTION
        ...
        <section className="relative overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.04] p-5 shadow-glow backdrop-blur-xl sm:rounded-[32px] sm:p-6 lg:w-[370px]">
          ...
          <div className="relative space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              >
                {isGameOver ? 'Novo jogo' : isRunning ? 'Pausar' : hasStarted ? 'Continuar' : 'Iniciar'}
              </button>
              <button
                type="button"
                onClick={resetGame}
