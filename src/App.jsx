...
function App() {
  ...
  useEffect(() => {
    ...
    // Optimization: Removed queuedDirection from dependency array so key presses
    // no longer clear and restart the game loop interval, preventing freezing on rapid inputs.
